...
# value/ordering. For example, the list [1,2,3] should return [1,3,2]. The list [1,3,2] should return [2,1,
# 3]. The list [3,2,1] should return [1,2,3]. Can you perform the operation without allocating extra memory (
