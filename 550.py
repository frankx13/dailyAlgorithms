...
# any currency, so that you can end up with some amount greater than A of that currency. There are no transaction
# costs and you can trade fractional quantities.
